...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Noticias - Categorias</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                ...
                                @foreach($newscategory as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/news-category/' . $item->id) }}" title="View NewsCategory"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            <a href="{{ url('/admin/news-category/' . $item->id . '/edit') }}" title="Edit NewsCategory"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                            {!! Form::open([
                                                'method' => 'DELETE',
                            ...
                            <div class="pagination-wrapper"> {!! $newscategory->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
