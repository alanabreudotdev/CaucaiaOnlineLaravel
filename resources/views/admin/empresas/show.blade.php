                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nome </th><td> {{ $empresa->nome }} </td></tr><tr><th> Tipo Conta Premium Id </th><td> {{ $empresa->tipo_conta_premium_id }} </td></tr><tr><th> Whatsapp </th><td> {{ $empresa->whatsapp }} </td></tr>
                                </tbody>
                            </table>
                        </div>
